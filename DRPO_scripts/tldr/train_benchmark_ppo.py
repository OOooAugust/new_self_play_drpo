...
script_args = ScriptArguments(
    dataset_name="Kyleyee/train_data_tldr",
...
training_args = PPOConfig(
    ...
    eval_strategy="steps",
    eval_steps=500,
    push_to_hub=False,  # Set to True to push the model to the hub
    save_strategy="steps",
    save_steps=500,
    output_dir="./selfmodel/output/ppo_tldr",
    hub_model_id="Kyleyee/pythia-1b-deduped-tldr-ppo",
    report_to=["wandb"],
)
